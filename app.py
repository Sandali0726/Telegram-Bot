...
def setup_llm_chain(topic="technology"):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system","You are a Joking AI. Give me only one joke from given topic"),
...
async def start(update: Update, context:ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Hi! Mention me with a topic like '@LifeFunny_bot python' to get a joke ")

async def help_command(update: Update, context:ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Mention me with a topic like '@LifeFunny_bot python' , to get some funny jokes ")
...
async def generate_joke(update: Update, context:ContextTypes.DEFAULT_TYPE, topic: str):
    ...
    # "hello          everyone      hii" ----> .strip()   -------> hello everyone hii
